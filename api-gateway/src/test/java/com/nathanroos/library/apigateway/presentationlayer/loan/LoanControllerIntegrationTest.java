...
class LoanControllerIntegrationTest {
    ...
    void testGetLoanById_Success() throws Exception {
        ...
        LoanResponseModel response = new LoanResponseModel(
                ...
                "John", "Doe", "Librarian", "Smith", "Title", "Author",
    ...
    void testGetAllLoans() throws Exception {
        LoanResponseModel response = new LoanResponseModel(
                "123e4567-e89b-12d3-a456-426614174000", "account-1", "librarian-1", "book-1",
                "John", "Doe", "Librarian", "Smith", "Title", "Author",
                null, new Date(), new Date()
        );
        ...
        mockMvc.perform(get("/api/v1/accounts/account-1/loans"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].loanId").value("123e4567-e89b-12d3-a456-426614174000"));
    }
    ...
    void testUpdateLoan() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/accounts/account-1/loans/" + validLoanId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.loanId").value(validLoanId));
    ...
    void testDeleteLoan() throws Exception {
        String validLoanId = "123e4567-e89b-12d3-a456-426614174000";
        mockMvc.perform(delete("/api/v1/accounts/account-1/loans/" + validLoanId))
